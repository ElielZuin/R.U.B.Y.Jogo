...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/verde3.png"), x = 2, y = 1, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 4, y = 4, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 3, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/roxo2.png"), x = 6, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/laranja2.png"), x = 3, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/caminhao1.png"), x = 1, y = 1, largura = 1, altura = 3, direcao = "vertical"},
