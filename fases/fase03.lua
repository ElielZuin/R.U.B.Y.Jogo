...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/azulclaro4.png"), x = 1, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/rosa3.png"), x = 1, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 4, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/bege1.png"), x = 1, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/roxo2.png"), x = 3, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/laranja1.png"), x = 4, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/caminhao1.png"), x = 4, y = 3, largura = 1, altura = 3, direcao = "vertical"},
