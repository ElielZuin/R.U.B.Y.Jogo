...
fase.fundoImagem = love.graphics.newImage("texturas/fundonoturno.png")
...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/amarelo3.png"), x = 1, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 1, y = 4, largura = 3, altura = 1, direcao = "horizontal"},
    ...
    {imagem = love.graphics.newImage("texturas/laranja1.png"), x = 4, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/rosa2.png"), x = 3, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/roxo2.png"), x = 4, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/azulclaro2.png"), x = 5, y = 3, largura = 1, altura = 2, direcao = "vertical"},
