...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/verde3.png"), x = 2, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    ...
    {imagem = love.graphics.newImage("texturas/laranja2.png"), x = 2, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/azulclaro4.png"), x = 3, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
}
