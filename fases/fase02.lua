...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/verde2.png"), x = 3, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    ...
    {imagem = love.graphics.newImage("texturas/laranja2.png"), x = 6, y = 5, largura = 1, altura = 2, direcao = "vertical"},
