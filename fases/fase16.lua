...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/roxo3.png"), x = 2, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/ciano4.png"), x = 4, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/bege3.png"), x = 1, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
