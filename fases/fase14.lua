...
fase.fundoImagem = love.graphics.newImage("texturas/fundocidade4.png")

fase.carros = {
    {imagem = love.graphics.newImage("texturas/vermelho.png"), x = 2, y = 3, largura = 2, altura = 1, direcao = "horizontal", tipo = "vermelho"},
    {imagem = love.graphics.newImage("texturas/bege3.png"), x = 4, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 4, y = 1, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 2, y = 4, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/marrom1.png"), x = 2, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/laranja1.png"), x = 1, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/roxo2.png"), x = 1, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/azulclaro1.png"), x = 3, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/ciano2.png"), x = 4, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/rosa2.png"), x = 6, y = 3, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/verde2.png"), x = 6, y = 5, largura = 1, altura = 2, direcao = "vertical"},
