...
fase.fundoImagem = love.graphics.newImage("texturas/fundocidade2.png")

fase.carros = {
    {imagem = love.graphics.newImage("texturas/vermelho.png"), x = 4, y = 3, largura = 2, altura = 1, direcao = "horizontal", tipo = "vermelho"},
    {imagem = love.graphics.newImage("texturas/bege3.png"), x = 4, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/laranja4.png"), x = 5, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/ciano4.png"), x = 5, y = 5, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 3, y = 1, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 3, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/verde1.png"), x = 3, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/azulclaro2.png"), x = 3, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/rosa2.png"), x = 4, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/onibus2.png"), x = 6, y = 1, largura = 1, altura = 3, direcao = "vertical"},
