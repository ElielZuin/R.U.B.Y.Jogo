...
fase.fundoImagem = love.graphics.newImage("texturas/fundocidade1.png")

fase.carros = {
    {imagem = love.graphics.newImage("texturas/vermelho.png"), x = 1, y = 3, largura = 2, altura = 1, direcao = "horizontal", tipo = "vermelho"},
    {imagem = love.graphics.newImage("texturas/laranja4.png"), x = 5, y = 1, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/rosa3.png"), x = 2, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/roxo4.png"), x = 4, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/azulclaro3.png"), x = 2, y = 5, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 1, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/azulescuro1.png"), x = 2, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/amarelo2.png"), x = 1, y = 4, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/ciano2.png"), x = 4, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/bege2.png"), x = 5, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/caminhao1.png"), x = 3, y = 1, largura = 1, altura = 3, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/onibus2.png"), x = 6, y = 4, largura = 1, altura = 3, direcao = "vertical"},
