...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/verde3.png"), x = 4, y = 1, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/laranja4.png"), x = 3, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/ciano3.png"), x = 1, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/marrom3.png"), x = 1, y = 5, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/azulescuro3.png"), x = 1, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/amarelo4.png"), x = 5, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 4, y = 5, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 4, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/azulclaro1.png"), x = 5, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/rosa1.png"), x = 3, y = 3, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/roxo2.png"), x = 4, y = 3, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/bege2.png"), x = 3, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/caminhao1.png"), x = 6, y = 1, largura = 1, altura = 3, direcao = "vertical"},
