...
fase.fundoImagem = love.graphics.newImage("texturas/fundonoturno1.png")
...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/bege3.png"), x = 3, y =5, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/amarelo4.png"), x = 3, y = 6, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/azulescuro4.png"), x = 4, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 4, y = 1, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/laranja2.png"), x = 4, y = 2, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/verde1.png"), x = 3, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/azulclaro1.png"), x = 3, y = 3, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/ciano2.png"), x = 1, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/marrom2.png"), x = 2, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/onibus2.png"), x = 6, y = 3, largura = 1, altura = 3, direcao = "vertical"},
