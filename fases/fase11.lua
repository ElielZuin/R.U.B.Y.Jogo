...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/azulescuro3.png"), x = 1, y = 1, largura = 2, altura = 1, direcao = "horizontal"},
    ...
    {imagem = love.graphics.newImage("texturas/limao1.png"), x = 3, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/caminhao1.png"), x = 4, y = 1, largura = 1, altura = 3, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/onibus2.png"), x = 1, y = 2, largura = 1, altura = 3, direcao = "vertical"},
