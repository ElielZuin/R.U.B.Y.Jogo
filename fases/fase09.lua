...
fase.carros = {
    ...
    {imagem = love.graphics.newImage("texturas/laranja3.png"), x = 3, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/azulclaro4.png"), x = 5, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/bege3.png"), x = 1, y = 4, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 2, y = 1, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/caminhao2.png"), x = 1, y = 5, largura = 3, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/onibus1.png"), x = 1, y = 6, largura = 3, altura = 1, direcao = "horizontal"},
    
    {imagem = love.graphics.newImage("texturas/verde1.png"), x = 1, y = 1, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/ciano2.png"), x = 5, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/amarelo2.png"), x = 6, y = 5, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/rosa2.png"), x = 3, y = 3, largura = 1, altura = 2, direcao = "vertical"},
    {imagem = love.graphics.newImage("texturas/onibus2.png"), x = 4, y = 4, largura = 1, altura = 3, direcao = "vertical"},
