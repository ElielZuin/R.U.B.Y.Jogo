...
fase.fundoImagem = love.graphics.newImage("texturas/fundo.png")

fase.carros = {
    {imagem = love.graphics.newImage("texturas/vermelho.png"), x = 1, y = 3, largura = 2, altura = 1, direcao = "horizontal", tipo = "vermelho"},
    {imagem = love.graphics.newImage("texturas/laranja3.png"), x = 2, y = 2, largura = 2, altura = 1, direcao = "horizontal"},
    {imagem = love.graphics.newImage("texturas/azulescuro4.png"), x = 4, y = 5, largura = 2, altura = 1, direcao = "horizontal"},
    ...
    {imagem = love.graphics.newImage("texturas/ciano1.png"), x = 4, y = 2, largura = 1, altura = 2, direcao = "vertical"},
